                      ...
                      <div className="widget-content">
                        ...
                        <div className="textwidget">
                          <p>
                            ...
                            Twenty theme to a Gatsby theme. It works uses the
                            new{" "}
                            <a
                          ...
                          <p>
                            Furthermore, I am using this site for a thesis,
                            which compares overall performance between a
                            php-based WordPress theme and a static Gatsby site.
                            I'll publish it on my site once it is done:{" "}
                            <a
